...
class NewsFilterFragment : Fragment() {
    ...
    override fun onViewCreated(
        ...
        binding.included.recyclerViewNewsFilterFragment.adapter = FilterAdapter(listOfFilters)
    }
    ...
    companion object {
        ...
        val listOfFilters =
            listOf(
                FilterCriteria(name = R.string.children, checked = true),
                FilterCriteria(name = R.string.adults, checked = true),
                FilterCriteria(name = R.string.elderly, checked = true),
                FilterCriteria(name = R.string.animals, checked = true),
                FilterCriteria(name = R.string.events, checked = true),
            )
    }
}
