package ru.faimizufarov.simbirtraining.java.java_tasks.rx_java.rx;
...
import ru.faimizufarov.simbirtraining.java.java_tasks.rx_java.exceptions.NotImplementedException;
...
public class RxCombiningTraining {
     ...
     */
    public Observable<Integer> summation(
